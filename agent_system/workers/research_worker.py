...
class ResearchWorker:
    ...
    def process(self, job: AgentJob) -> AgentJob:
        ...
        job.steps = [
            ...
            JobStep(name="source_collection", status="running", note="조사 보고서와 구현 메모를 준비하고 있습니다."),
            JobStep(name="research_summary", status="pending", note="구현에 바로 연결할 조사 결과를 정리합니다."),
        ]
